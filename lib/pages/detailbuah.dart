...
class DetailBuah extends StatefulWidget{
   List list; 
   int index;
   DetailBuah({this.index, this.list});
   @override 
   _DetailBuahState createState() => new _DetailBuahState();
}

class _DetailBuahState extends State<DetailBuah>{
  @override 
  Widget build(BuildContext context){
    return new Scaffold(
      body: new ListView(
              children: <Widget>[
                new Text(widget.list[widget.index]['buah'], style: new TextStyle(fontSize: 20.0),),
